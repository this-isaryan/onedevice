...
if (isset($_POST["action"])) {
	$query = "select product.*, brands.brand from product, brands where product.status = 1 and product.categories_id = 1 and product.brand_id=brands.id AND brands.brand IN('vivo')";
