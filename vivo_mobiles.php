<?php
require('top.php');
$get_product = get_product($con, '', '1', '', '', '7');
?>
								...
								<div class="filterboxpanel">
									<div class="filter_panel">
										...
										<div class="list-group">
											...
											$query = "SELECT DISTINCT(ramemory) FROM product WHERE status = '1' AND brand_id = '7' AND ramemory IS NOT NULL ORDER BY ramemory";
										...
										<div class="list-group">
											...
											<?php
											$query = "SELECT DISTINCT(intmem) FROM product WHERE status = '1' AND brand_id = '7' AND intmem IS NOT NULL ORDER BY intmem";
											$statement = $connect->prepare($query);
											$statement->execute();
											$result = $statement->fetchAll();
											foreach ($result as $row) {
										...
										<div class="list-group">
											...
											<?php
											$query = "SELECT DISTINCT(camset) FROM product WHERE status = '1' AND brand_id = '7' AND camset IS NOT NULL ORDER BY camset";
											$statement = $connect->prepare($query);
											$statement->execute();
											$result = $statement->fetchAll();
											foreach ($result as $row) {
											...
											<?php
											$query = "SELECT DISTINCT(mcamera) FROM product WHERE status = '1' AND brand_id = '7' AND mcamera IS NOT NULL ORDER BY mcamera";
											$statement = $connect->prepare($query);
											$statement->execute();
											$result = $statement->fetchAll();
											foreach ($result as $row) {
											...
											<?php
											$query = "SELECT DISTINCT(fcamset) FROM product WHERE status = '1' AND brand_id = '7' AND fcamset IS NOT NULL ORDER BY fcamset";
											$statement = $connect->prepare($query);
											$statement->execute();
											$result = $statement->fetchAll();
											foreach ($result as $row) {
											...
											<?php
											$query = "SELECT DISTINCT(fcam) FROM product WHERE status = '1' AND brand_id = '7' AND fcam IS NOT NULL ORDER BY fcam";
											$statement = $connect->prepare($query);
											$statement->execute();
											$result = $statement->fetchAll();
											foreach ($result as $row) {
										...
										<div class="list-group">
											...
											<h3>Display Type</h3>
											<?php
											$query = "SELECT DISTINCT(distype) FROM product WHERE status = '1' AND brand_id = '7' AND distype IS NOT NULL ORDER BY distype";
											$statement = $connect->prepare($query);
											$statement->execute();
											$result = $statement->fetchAll();
											foreach ($result as $row) {
											...
											<h3>Refresh Rate</h3>
											<?php
											$query = "SELECT DISTINCT(refrate) FROM product WHERE status = '1' AND brand_id = '7' AND refrate IS NOT NULL ORDER BY refrate";
											$statement = $connect->prepare($query);
											$statement->execute();
											$result = $statement->fetchAll();
											foreach ($result as $row) {
										...
										<div class="list-group">
											...
											<?php
											$query = "SELECT DISTINCT(mchip) FROM product WHERE status = '1' AND brand_id = '7' AND mchip IS NOT NULL";
											$statement = $connect->prepare($query);
											$statement->execute();
											$result = $statement->fetchAll();
											foreach ($result as $row) {
											...
											<?php
											$query = "SELECT DISTINCT(mPCores) FROM product WHERE status = '1' AND brand_id = '7' AND mPCores IS NOT NULL";
											$statement = $connect->prepare($query);
											$statement->execute();
											$result = $statement->fetchAll();
											foreach ($result as $row) {
										...
										<div class="list-group">
											...
											<?php
											$query = "SELECT DISTINCT(osv) FROM product WHERE status = '1' AND brand_id = '7' ORDER BY osv";
											$statement = $connect->prepare($query);
											$statement->execute();
											$result = $statement->fetchAll();
											foreach ($result as $row) {
