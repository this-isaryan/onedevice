...
$check_password=get_safe_value($con,$_POST['check_password']);
$uemail=$_SESSION['USER_EMAIL'];
$res=mysqli_query($con,"select * from users where email='$uemail' and password='$check_password'");
...
if($check_user>0){
														...
														<table border='0' cellpadding='0' cellspacing='0' class='image_block' role='presentation' style='mso-table-lspace: 0pt; mso-table-rspace: 0pt;' width='100%'>
															<tr>
																<td style='width:100%;padding-right:0px;padding-left:0px;'>
																	<div align='center' style='line-height:10px'><img alt='Brand Logo' src='https://onedevice.s3.ap-south-1.amazonaws.com/Logo.png' style='display: block; height: auto; border: 0; width: 154px; max-width: 100%;' title='Brand Logo' width='154'
																		/></div>
																</td>
															</tr>
														</table>
																...
																<td style='padding-bottom:10px;padding-left:40px;padding-right:40px;padding-top:10px;'>
																	<div style='font-family: sans-serif'>
																		<div style='font-size: 12px; mso-line-height-alt: 18px; color: #191919; line-height: 1.5; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;'>
																			...
																			<p style='margin: 0; font-size: 16px; text-align: center;'>
																				<strong><span
																						style='font-size:38px;'>Your Password is mentioned below!</span></strong></p>
																		</div>
																	</div>
																</td>
															</tr>
																...
																<td style='padding-bottom:10px;padding-left:40px;padding-right:30px;'>
																	<div style='font-family: sans-serif'>
																		<div style='font-size: 12px; mso-line-height-alt: 24px; color: #555555; line-height: 2; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;'>
																			<h2>Your One Time Password is: $OTP</h2>
																		</div>
																	</div>
																</td>
															</tr>
												...
												<tr>
													<td class='column column-1' style='mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top; padding-top: 0px; padding-bottom: 5px; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;'
														...
														<table border='0' cellpadding='0' cellspacing='0' class='image_block' role='presentation' style='mso-table-lspace: 0pt; mso-table-rspace: 0pt;' width='100%'>
															<tr>
																<td style='width:100%;padding-right:0px;padding-left:0px;'>
																	<div align='center' style='line-height:10px'><img class='big' src='https://onedevice.s3.ap-south-1.amazonaws.com/email+images/white_down.png' style='display: block; height: auto; border: 0; width: 700px; max-width: 100%;' width='700'
																		/></div>
																</td>
															</tr>
														</table>
	...
	$mail->IsHTML(true);
	$mail->Subject = "Your OTP to delete your account ";
	$mail->Body = $html;
