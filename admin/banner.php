			...
			<div class="col-xl-12">
				<div class="card">
					<div class="card-body top-head">
						...
						<h4 class="box-link"><a href="manage_banner.php" class="btn">Add Banner</a></h4>
					</div>
					<div class="card-body--">
								...
								<tbody>
									...
									while ($row = mysqli_fetch_assoc($res)) { ?>
										<tr>
											...
											<td><?php echo "<a target='_blank' href='" . BANNER_SITE_PATH . $row['image'] . "'><img width='150px' src='" . BANNER_SITE_PATH . $row['image'] . "'/></a>";
												?></td>
											<td>
												<?php
												if ($row['status'] == 1) {
												...
												echo "<span class='badge badge-edit'><a href='manage_banner.php?id=" . $row['id'] . "'><ion-icon name='create-outline'></ion-icon></a></span>";
