...
$sql = "select brands.*, categories.categories from brands, categories where categories.id=brands.categories_id order by brands.id asc";
			...
			<div class="col-xl-12">
				<div class="card">
					<div class="card-body top-head">
						...
						<h4 class="box-link"><a href="manage_brand.php" class="btn">Add Brand</a></h4>
					</div>
					<div class="card-body--">
									...
									while ($row = mysqli_fetch_assoc($res)) { ?>
										<tr>
											...
											<td>
												...
												echo "<span class='badge badge-edit'><a href='manage_brand.php?id=" . $row['id'] . "'><ion-icon name='create-outline'></ion-icon></a></span>";
